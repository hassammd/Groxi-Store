...
const NavBar = () => {
  ...
  return (
    <>
      <div className="absolute z-20 w-full top-3">
                    ...
                    {NavLinkes.map((items) => {
                      return (
                        <li className="cursor-pointer">
                          <Link
                            to={items.path}
                            className="font-barlow text-[20px] text-[var(--color-darkblue)] font-normal leading-[20px] py-[10px]"
                          >
                            {items.name}
                          </Link>
                        </li>
